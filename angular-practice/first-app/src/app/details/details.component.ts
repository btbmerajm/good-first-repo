    ...
    <article>
      ...
      <section class="listing-apply">
        ...
        <form [formGroup]="applyForm" (submit)="submitApplication()" >
          ...
          <input id="first-name" type="text" form-control-name="firstName" />

          <label for="last-name">Last Name</label>
          <input id="last-name" type="text" form-control-name="lastName" />

          <label for="email">Email</label>
          <input id="email" type="email" form-control-name="email" />
